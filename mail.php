...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $content = $name . ' оставил заявку на ' . $data . ' ' . $time . 'Выбрал услугу у барбера ' . $barber . ' ' . $service . '. Его телефон: ' . $phone . '.';

    // Первый параметр - кому отправляем письмо, второй - тема письма, третий - содержание
    $success = mail("admin@barbershop.com", 'Запрос на бронирование столика', $content);
